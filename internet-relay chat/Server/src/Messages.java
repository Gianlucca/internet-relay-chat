public class Messages {
    ...
    public final static String NAME_CONTAINS_SPACE  = "Nick não pode conter espaços.";
    public final static String CHANNEL_NAME_CONTAINS_SPACE  = "Nome do canal não pode conter espaços.";
    public final static String CHANGED_NAME  = " mudou o nome para ";
    public final static String CHANNEL_ALREADY_EXISTS = "Nome do canal já existe.";
    ...
    public final static String INVALID_COMMAND = "Comando inválido.";
