public class Messages {
    ...
    public final static String CHANNEL_HELP = "Comandos de canais do IRC:\n\t/nick <nickname> - altera seu usuario \n\t/join <channel> - entra em um canal, se o canal não existir, funciona como /create \n\t/list - lista os canais disponiveis \n\t/part -  Solicita a saida do canal atual\n\t/msg <nickname> <message> - envia mensagem privada (PM) para um usuario \n\t/names - lista todos os nomes dos usuarios que fazem parte do canal \n\t/remove <channel> - solicita a remoção de um canal (APENAS ADMIN)\n\t/kick <nickname> - Solicita a remoção de um usuario de um canal (APENAS ADMIN) \n\t/quit - Encerra sua sessão";
